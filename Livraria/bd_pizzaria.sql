...
--cliente
INSERT INTO CLIENTE (COD_CLIENTE,NOME,TELEFONE,ENDERECO)
VALUES (2,'NICOLAS','95237605','RUA_DAS_CASTANHAS');

SELECT * FROM CLIENTE;

UPDATE  CLIENTE SET NOME = 'ZÉDOMILHO' WHERE COD_CLIENTE  = 2;
...
VALUES (2,5,154,180.00,2);

SELECT  * FROM COTACAO ;

UPDATE COTACAO  SET VLR_COTACAO  = 25.00 WHERE COD_PRODUTO = 5;

DELETE FROM COTACAO  WHERE COD_PRODUTO = 5;
...
UPDATE FORMA_PAGAMENTO  SET DES_FORMA_PAGAMENTO  = 'PIX' WHERE COD_FORMA_PAGAMENTO = 2;

DELETE FROM FORMA_PAGAMENTO  WHERE COD_FORMA_PAGAMENTO = 2;

--FORNECEDOR
INSERT INTO FORNECEDOR (COD_FORNECEDOR,NOME,ENDERECO,TELEFONE)
VALUES (2,'Kleber','RUA_JOSE_FLORES','12654765');

SELECT * FROM FORNECEDOR f ;

UPDATE FORNECEDOR  SET ENDERECO  = 'RUA_DO_FOGUETE' WHERE COD_FORNECEDOR  = 2;
...
INSERT INTO ITEM_PEDIDO_COMPRA (COD_ITEM_PEDIDO_COMPRA,COD_PEDIDO_COMPRA,COD_PRODUTO,QTD_ITEM_PEDIDO_COMPRA)
VALUES (35,56,6,5);

UPDATE ITEM_PEDIDO_COMPRA  SET QTD_ITEM_PEDIDO_COMPRA  = 400 WHERE COD_PRODUTO = 6;

DELETE FROM ITEM_PEDIDO_COMPRA  WHERE COD_ITEM_PEDIDO_COMPRA = 35;
...
UPDATE ITEM_PEDIDO_VENDA  SET QTD_ITEM_PEDIDO_VENDA = 2 WHERE COD_PEDIDO_VENDA = 4;

DELETE FROM ITEM_PEDIDO_VENDA WHERE ITEM_PEDIDO_VENDA.QTD_ITEM_PEDIDO_VENDA = 0;

--PEDIDO COMPRA
SELECT * FROM PEDIDO_COMPRA pc ;

INSERT INTO PEDIDO_COMPRA (COD_PEDIDO_COMPRA,COD_FORNECEDOR,VLR_PEDIDO_COMPRA)
VALUES (2,4,85.35);

UPDATE PEDIDO_COMPRA SET VLR_PEDIDO_COMPRA = 25.60 WHERE COD_PEDIDO_COMPRA = 2;

DELETE FROM PEDIDO_COMPRA  WHERE COD_FORNECEDOR = 4;
...
VALUES (3,54,12,'APROVADO','DÉBITO',18/12,56.90);
